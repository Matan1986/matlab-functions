...
## Data sources
- **PT_matrix (tail features)**: `results/switching/runs/run_2026_03_25_013849_pt_robust_minpts7/tables/PT_matrix.csv`
...
*Note: Canonical decomposition used PT from `run_2026_03_24_212033_switching_barrier_distribution_from_map`; this report uses **latest** PT row shapes (`run_2026_03_25_013849_pt_robust_minpts7`) for tail metrics.*
