function smoothed_data = analysisAndFittACHC(Temp_table, HC_table, sortedFields, colors, peak_width, poly_order, temp_jump_threshold, moving_avg_window,Fontsize)
