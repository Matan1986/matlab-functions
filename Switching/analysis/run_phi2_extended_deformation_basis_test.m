...
try
    ...
    alignmentCorePath = fullfile(repoRoot, 'results', 'switching', 'runs', alignmentRunId, ...
        'switching_alignment_core_data.mat');
    fullScalingParamsPath = fullfile(repoRoot, 'results', 'switching', 'runs', fullScalingRunId, ...
        'tables', 'switching_full_scaling_parameters.csv');
    ptMatrixPath = fullfile(repoRoot, 'results', 'switching', 'runs', ptRunId, ...
