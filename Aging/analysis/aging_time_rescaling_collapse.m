...
f7gMeta = struct( ...
    'writer_family_id', 'WF_TAU_RESCALING_OPTIMIZER', ...
    'tau_or_R_flag', 'TAU', ...
    'tau_domain', 'DIP_DEPTH_COLLAPSE_OPTIMIZER', ...
    'tau_input_observable_identities', '{"Dip_depth":"normalized_curves_objective_NOT_curve_fit_consensus"}', ...
    'tau_input_observable_family', 'Dip_depth_rescaling_optimizer', ...
    'source_writer_script', 'Aging/analysis/aging_time_rescaling_collapse.m', ...
    'source_artifact_basename', 'tau_rescaling_estimates.csv', ...
    'source_artifact_path', fullfile(runDir, 'tables', 'tau_rescaling_estimates.csv'), ...
    'canonical_status', 'non_canonical_pending_lineage', ...
    'model_use_allowed', 'NO_DO_NOT_EQUIVALENCE_WITH_TAU_VS_TP', ...
    'semantic_status', 'tau_estimate_seconds_optimizer_distinct_from_curve_fit', ...
    'lineage_status', 'REQUIRES_DATASET_PATH');
