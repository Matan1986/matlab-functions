...
f7gMeta = struct( ...
    ...
    'tau_or_R_flag', 'NONE', ...
    'tau_domain', 'FM_COLLAPSE_UNDER_DIP_CURVE_TAU_CLOCK', ...
    'tau_input_observable_identities', ['tau_clock_table=' char(string(cfg.tauPath)) ';dataset=' char(string(cfg.datasetPath))], ...
    'tau_input_observable_family', 'FM_abs_with_external_dip_tau_table', ...
    'source_writer_script', 'Aging/analysis/aging_fm_using_dip_clock.m', ...
    'source_artifact_basename', 'fm_collapse_using_dip_tau_metrics.csv', ...
    'source_artifact_path', fullfile(runDir, 'tables', 'fm_collapse_using_dip_tau_metrics.csv'), ...
    'canonical_status', 'non_canonical_pending_lineage', ...
    'model_use_allowed', 'DIAGNOSTIC_COLLAPSE_RMSE_ONLY_NOT_PHYSICAL_TAU', ...
    'semantic_status', 'TABLE_IS_SCENARIO_RMSE_NOT_SCALAR_TAU_EXTRACTION', ...
    'lineage_status', 'DIP_TAU_SOURCE_FROM_CFG_TAU_PATH');
metricsTbl = appendF7GTauRMetadataColumns(metricsTbl, f7gMeta);
