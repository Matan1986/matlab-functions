...
%
% PURPOSE:
%   Plot M(T) and DeltaM(T) for no-pause and pause runs.
%
% INPUTS:
%   T_no, M_no   - no-pause temperature and magnetization
%   pauseRuns    - pause run struct array
%   color_scheme - colormap scheme name
%   fontsize     - base font size
%   linewidth    - base line width
%   sample_name  - label for figures
%   Bohar_units  - true for uB/Co, false for emu/g
%   offsetMode   - 'vertical', 'horizontal', or 'none'
%   offsetPercent- offset magnitude
%   dip_window_K - dip window (optional)
%   colorRange   - colormap compression range
%   useAutoYScale- automatic scale selection
%
% OUTPUTS:
%   none (creates figures)
%
% Physics meaning:
%   AFM = dip in DeltaM for pause runs
%   FM  = background trends in M(T) and DeltaM(T)
%
% =========================================================
