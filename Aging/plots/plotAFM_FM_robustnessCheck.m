...
%
% PURPOSE:
%   Evaluate robustness of AFM/FM decomposition over parameter sweeps.
%
% INPUTS:
...
%   excludeLowT_mode- 'pre' or 'post'
%   paramSet        - array of parameter structs for sweeps
%   fontsize        - base font size
%   plotOpts        - plotting options
%
% OUTPUTS:
%   AFM_all         - AFM metric matrix [nSet x nTp]
%   FM_all          - FM metric matrix [nSet x nTp]
%   diag            - diagnostics struct
%
% Physics meaning:
%   AFM = sharp dip metric across parameter sets
%   FM  = smooth background step metric across parameter sets
%
% =========================================================
...
if plotOpts.printToCMD
    ...
    fprintf('  %-4s %-6s  %-9s %-10s %-10s %-10s  %-12s  %s\n', ...
