function plot_founded_increasing_temperature_segments_MT(Timems, TemperatureK, FieldT,segments_increasing_temp,filtered_temp)
%% Plot Increasing Temperature Segments
    ...
    for i = 1:size(segments_increasing_temp, 1)
        segment_start_temp = segments_increasing_temp(i, 1);
        segment_end_temp = segments_increasing_temp(i, 2);
